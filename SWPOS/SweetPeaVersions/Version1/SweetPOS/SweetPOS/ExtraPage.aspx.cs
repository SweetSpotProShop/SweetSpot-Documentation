...
namespace SweetPOS
{
    public partial class ExtraPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["currentPage"] = "ExtraPage.aspx";
            try
            {
            ...
            try
            {
                ...
                else
                {
                    if (RM.VerifyAMethodOfPaymentHasBeenAdded(receipt.intReceiptID, CU.terminal.intBusinessNumber))
                    {
                        ...
                        var nameValues = HttpUtility.ParseQueryString(Request.QueryString.ToString());
                        nameValues.Set("receipt", receipt.intReceiptID.ToString());
                        Response.Redirect("PrintableReceiptReturn.aspx?" + nameValues, false);
                    }
                    else
                    {
        ...
        private void UpdatePageTotals()
        {
            ...
            try
            {
                ...
                lblRefundSubTotalAmount.Text = subAmount.ToString("C");
                subAmount += receipt.fltGovernmentTaxTotal + receipt.fltProvincialTaxTotal;
                lblRefundBalanceAmount.Text = subAmount.ToString("C");
                ...
                lblRemainingRefundDisplay.Text = subAmount.ToString("C");
                txtAmountRefunding.Text = subAmount.ToString("C");
