                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" CssClass="auto-style1">
                        <asp:Table runat="server">
                            ...
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Button ID="mopAmericanExpress" runat="server" Text="American Express" OnClick="mopAmericanExpress_Click" Width="163px" OnClientClick="return confirm('Confirm American Express');" CausesValidation="false" />
                                </asp:TableCell>
                                <asp:TableCell>
							...
							<asp:TableRow>
                                <asp:TableCell>
									<asp:Button ID="mopCheque" runat="server" Text="Cheque" OnClick="mopCheque_Click" Width="163px" OnClientClick="return confirm('Confirm Cheque');" CausesValidation="false" />
                                </asp:TableCell>
                                <asp:TableCell>
							...
							<asp:TableRow>
                                <asp:TableCell>
									<asp:Button ID="mopDiscover" runat="server" Text="Discover" OnClick="mopDiscover_Click" Width="163px" OnClientClick="return confirm('Confirm Discover');" CausesValidation="false" />
                                </asp:TableCell>
                                <asp:TableCell>
