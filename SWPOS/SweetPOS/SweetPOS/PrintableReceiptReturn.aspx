<%@ Page Title="" Language="C#" MasterPageFile="~/SweetPOSMasterPage.Master" AutoEventWireup="true" CodeBehind="PrintableReceiptReturn.aspx.cs" Inherits="SweetPOS.PrintableReceiptReturn" %>
...
<asp:Content ID="printableReceiptReturnDisplay" ContentPlaceHolderID="IndividualPageContent" runat="server">
    <script>
        ...
        <div id="finalReceipt" class="yesPrint">
            ...
            <asp:GridView ID="grdItemsSoldList" runat="server" CellPadding="4" Width="100%" AutoGenerateColumns="False" RowStyle-HorizontalAlign="Center">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sold At">
                        <ItemTemplate>
                            <asp:Label ID="lblItemPrice" Text='<%# (Convert.ToDouble(Eval("fltItemPrice"))).ToString("C") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Non Refundable">
                        <ItemTemplate>
							<asp:Label ID="lblItemDiscount" Text='<%# (Convert.ToDouble(Eval("fltItemPrice")) + Convert.ToDouble(Eval("fltItemRefund"))).ToString("C") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Returned At">
                        <ItemTemplate>
                            <asp:Label ID="lblItemSalePrice" Text='<%# Eval("fltItemRefund", "{0:C}") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Extended Price">
                        <ItemTemplate>
							<asp:Label ID="lblItemExtendedPrice" Text='<%# (Convert.ToDouble(Eval("fltItemRefund")) * Convert.ToDouble(Eval("intItemQuantity"))).ToString("C") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
            ...
            <asp:Table ID="tblSummary" runat="server" Width="70%">
                <asp:TableRow>
                    <asp:TableCell CssClass="leftFirst">
                        <asp:Label ID="lblDiscounts" runat="server" Text="Discounts:" Visible="false" />
                    </asp:TableCell>
                    <asp:TableCell CssClass="leftSecond">
                        <asp:Label ID="lblDiscountsDisplay" runat="server" DataFormatString="{0:C}" Visible="false" />
                    </asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell CssClass="leftFirst">
                        <asp:Label ID="lblTradeIns" runat="server" Text="Trade-Ins:" Visible="false" />
                    </asp:TableCell>
                    <asp:TableCell CssClass="leftSecond">
                        <asp:Label ID="lblTradeInsDisplay" runat="server" DataFormatString="{0:C}" Visible="false" />
                    </asp:TableCell>
                    <asp:TableCell CssClass="rightFirst">
