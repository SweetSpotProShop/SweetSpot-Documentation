    ...
    public partial class PurchasesCart : System.Web.UI.Page
    {
        ...
        protected void btnAddPurchase_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Inventory newTrade = InvM.ReturnInventoryItem(IM.AddPurchaseTradeInToInventoryTable(selectedItem, Convert.ToDateTime(CUM.ConvertDate(DateTime.Now.ToLocalTime())), CU), CU.terminal.intBusinessNumber, Convert.ToDateTime(CUM.ConvertDate(DateTime.Now.ToLocalTime())))[0];
