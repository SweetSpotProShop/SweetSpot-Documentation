    ...
    public partial class CustomerAddNew : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    if (Convert.ToInt32(Request.QueryString["customer"].ToString()) != -10)
                    {
                        if (!IsPostBack)
                        {
                            ...
                            chkCustomerHasAccount.Checked = customer.bitCustomerHasAccount;
                            txtAmountOwing.Text = customer.fltAmountOwing.ToString("C");
                    ...
                    else
                    {
                        ...
                        chkCustomerHasAccount.Enabled = true;
        ...
        protected void btnAddCustomer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                c.bitCustomerHasAccount = chkCustomerHasAccount.Checked;
        ...
        protected void btnSaveCustomer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                chkCustomerHasAccount.Enabled = false;
