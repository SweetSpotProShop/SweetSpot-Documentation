...
namespace SweetPOS.ClassObjects
{
    public class PurchaseOrderManager
    {
        ...
        private List<PurchaseOrder> ConvertFromDataTableToVendorSupplierPurchaseOrder(DataTable dt, int businessNumber)
        {
            VendorSupplierManager VSM = new VendorSupplierManager();
            EmployeeManager EM = new EmployeeManager();
            LocationManager LM = new LocationManager();
        ...
        private List<PurchaseOrder> GatherVendorSupplierPurchaseOrders(int vendorSupplierID, int businessNumber)
        {
            string sqlCmd = "SELECT intPurchaseOrderID, varPurchaseOrderNumber, dtmPurchaseOrderCreationDate, dtmPurchaseOrderCompletionDate, "
                + "intEmployeeID, fltCostSubTotal, fltGSTTotal, fltPSTTotal, bitGSTCharged, bitPSTCharged, varPurchaseOrderComments FROM tbl"
                + businessNumber + "PurchaseOrder WHERE intVendorSupplierID = @intVendorSupplierID";
            object[][] parms =
            {
                new object[] { "@intVendorSupplierID", vendorSupplierID }
            };
            return ConvertFromDataTableToVendorSupplierPurchaseOrder(DBC.MakeDatabaseCallToReturnDataTable(sqlCmd, parms), businessNumber);
        }
        ...
        public List<PurchaseOrder> ReturnVendorSupplierPurchaseOrders(int vendorSupplierID, int businessNumber)
        {
            return GatherVendorSupplierPurchaseOrders(vendorSupplierID, businessNumber);
        }
