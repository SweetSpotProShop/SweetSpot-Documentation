...
namespace SweetPOS.ClassObjects
{
    public class CreateCompanyDatabase
    {
        ...
        public void CreateAllTableData(int businessNumber)
        {
            ...
            createTaxRateByProvince(businessNumber);
            createActiveInactive(businessNumber);
            ...
            //Account Tables
            createChargedToAccount(businessNumber);
            createPaidOnAccount(businessNumber);
        }
        ...
        private void createCustomer(object businessNumber)
        {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "Customer(intCustomerID INT NOT NULL "
                ...
                + "NULL, bitAllowMarketing BIT NOT NULL, bitCustomerHasAccount BIT NOT NULL);";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        ...
        private void createVendorSupplier(object businessNumber)
        {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "VendorSupplier(intVendorSupplierID "
                ...
                + "varVendorSupplierCode VARCHAR(6) NOT NULL, bitIsActive BIT NOT NULL);";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        ...
        private void createTaxRateByProvince(object businessNumber)
        {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "TaxRateByProvince(intProvinceID "
                + "INT NOT NULL FOREIGN KEY REFERENCES tblProvinceID(intProvinceID, intTaxTypeID INT NOT NULL FOREIGN "
                + "KEY REFERENCES tblTaxType(intTaxTypeID), dtmTaxEffectiveDate DATE NOT NULL, fltTaxRate FLOAT NOT "
                + "NULL, PRIMARY KEY(intProvinceID, intTaxTypeID, dtmTaxEffectiveDate));";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        private void createActiveInactive(object businessNumber)
        {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "ActiveInactive(intActiveInactive INT NOT "
                + "NULL IDENTITY(1, 1) PRIMARY KEY, varActiveInactive VARCHAR(15) NOT NULL)";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        ...
        //Account Tables
        private void createChargedToAccount(object businessNumber) {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "ChargedToAccount(intChargedToAccountID "
                + "INT NOT NULL IDENTITY(1, 1) PRIMARY KEY, intCustomerID INT NOT NULL FOREIGN KEY REFERENCES tbl" 
                + Convert.ToInt32(businessNumber) + "Customer(intCustomerID), intReceiptID INT NOT NULL FOREIGN KEY "
                + "REFERENCES tbl" + Convert.ToInt32(businessNumber) + "Receipt(intReceiptID), fltChargedToAccountAmount "
                + "FLOAT NOT NULL);";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        private void createPaidOnAccount(object businessNumber)
        {
            string sqlCmd = "CREATE TABLE tbl" + Convert.ToInt32(businessNumber) + "PaidOnAccount(intPaidOnAccountID "
                + "INT NOT NULL IDENTITY(1, 1) PRIMARY KEY, intCustomerID INT NOT NULL FOREIGN KEY REFERENCES tbl" 
                + Convert.ToInt32(businessNumber) + "Customer(intCustomerID), dtmPaidDate DATE NOT NULL, "
                + "fltPaidOnAccountAmount FLOAT NOT NULL)";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
    }
