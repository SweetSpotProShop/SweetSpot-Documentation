...
namespace SweetPOS.ClassObjects
{
    public class DeleteCompanyDatabase
    {
        ...
        {
            //Account Tables
            DELETEChargedToAccount(businessNumber);
            DELETEPaidOnAccount(businessNumber);
            ...
            DELETEActiveInactive(businessNumber);
            DELETETaxRateByProvince(businessNumber);
        ...
        //Per Inventory Tables
        private void DELETEActiveInactive(object businessNumber)
        {
            string sqlCmd = "DROP TABLE tbl" + Convert.ToInt32(businessNumber) + "ActiveInactive;";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        private void DELETETaxRateByProvince(object businessNumber)
        {
            string sqlCmd = "DROP TABLE tbl" + Convert.ToInt32(businessNumber) + "TaxRateByProvince;";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        ...
        private void DELETEInitializationOfBusiness(object businessNumber)
        {
        ...
        //Account Tables
        private void DELETEChargedToAccount(object businessNumber)
        {
            string sqlCmd = "DROP TABLE tbl" + Convert.ToInt32(businessNumber) + "ChargedToAccount";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
        private void DELETEPaidOnAccount(object businessNumber)
        {
            string sqlCmd = "DROP TABLE tbl" + Convert.ToInt32(businessNumber) + "PaidOnAccount";
            object[][] parms = { };
            DBC.ExecuteNonReturnQuery(sqlCmd, parms);
        }
    }
