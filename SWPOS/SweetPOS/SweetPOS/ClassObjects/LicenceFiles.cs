...
namespace SweetPOS.ClassObjects
{
    public class LicenceFiles
    {
        ...
        private void SetTaxTypesForTradeInInventory(int inventoryID, DateTime taxDateTime, int businessNumber)
        {
            //This will tie all taxes to the item as all items require taxtypes
            InventoryManager IM = new InventoryManager();
            IM.SetTaxesForNewInventory(inventoryID, false, taxDateTime, businessNumber);
        }
        ...
        public void CreateFirstObjectData(StoreLocation storeLocation, DateTime currentDate, int businessNumber)
        {
            ...
            SetTaxTypesForTradeInInventory(inventoryID, currentDate, businessNumber);
            ...
            InsertActiveInactive(businessNumber);
        }
        private void InsertActiveInactive(int businessNumber)
        {
            string sqlCmd1 = "INSERT INTO tbl" + businessNumber + "ActiveInactive VALUES('Active')";
            string sqlCmd2 = "INSERT INTO tbl" + businessNumber + "ActiveInactive VALUES('Inactive')";
            string sqlCmd3 = "INSERT INTO tbl" + businessNumber + "ActiveInactive VALUES('Both')";

            object[][] parms = { };

            DBC.ExecuteNonReturnQuery(sqlCmd1, parms);
            DBC.ExecuteNonReturnQuery(sqlCmd2, parms);
            DBC.ExecuteNonReturnQuery(sqlCmd3, parms);
        }
    }
}