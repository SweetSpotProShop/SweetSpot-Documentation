    ...
    public partial class InventoryHomePage : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        ddlActiveInactiveSelect.DataSource = IM.ReturnDropDownForActiveInactive(CU.terminal.intBusinessNumber);
                        ddlActiveInactiveSelect.DataBind();
                    }
                }
            }
            //Exception catch
        ...
        protected void btnInventorySearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                searched = IM.ReturnInventoryFromSearchString(txtSearch.Text, Convert.ToInt32(ddlActiveInactiveSelect.SelectedValue), CU.terminal.intBusinessNumber);
