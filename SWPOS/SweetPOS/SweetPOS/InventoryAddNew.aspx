		...
		<asp:Panel ID="pnlDefaultButton" runat="server" DefaultButton="btnSaveItem">
			...
			<asp:Table ID="Table1" runat="server" Width="100%">
				...
				<asp:TableRow>
					...
					<asp:TableCell>
						<asp:CheckBox ID="chkActiveProduct" runat="server" Text="Active Product" Enabled="false" />
					</asp:TableCell>
				...
				<asp:TableRow>
					...
					<asp:TableCell ColumnSpan="2" RowSpan="2" HorizontalAlign="Center">
						...
						<asp:GridView ID="grdInventoryTaxes" runat="server" AutoGenerateColumns="false" Width="100%"
							RowStyle-HorizontalAlign="Center" OnRowDataBound="grdInventoryTaxes_RowDataBound"
							OnRowCommand="grdInventoryTaxes_RowCommand">
							<Columns>
								<asp:TemplateField>
									<ItemTemplate>
										<asp:LinkButton ID="lbtnChangeCharged" runat="server" Text="Remove" CommandArgument='<%#Eval("intTaxTypeID") %>' />
									</ItemTemplate>
								</asp:TemplateField>
								<asp:BoundField DataField="varTaxName" ReadOnly="true" HeaderText="Tax Name" />
								<asp:BoundField DataField="fltTaxRate" ReadOnly="true" HeaderText="Tax Rate" />
				...
				<asp:TableRow>
					<asp:TableCell ColumnSpan="2" Width="100%" Height="100%" HorizontalAlign="Center">
						<asp:TextBox Height="100%" Width="80%" TextMode="MultiLine" ID="txtAdditionalInformation" runat="server" AutoComplete="off" Enabled="false" />
					</asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
					<asp:TableCell ColumnSpan="4">
