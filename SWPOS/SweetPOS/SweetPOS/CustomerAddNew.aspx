        ...
        <asp:panel id="pnlDefaultButton" runat="server" defaultbutton="btnSaveCustomer">
            ...
            <asp:Table ID="Table1" runat="server" Width="100%">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>						
						<asp:CheckBox ID="chkCustomerHasAccount" runat="server" Text="Has Account" Enabled="false"/>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
						<asp:Label ID="lblAmountOwing" runat="server" Text="Amount Owing:" />
                    </asp:TableCell>
                    <asp:TableCell>
                        <asp:TextBox ID="txtAmountOwing" runat="server" AutoComplete="off" Enabled="false" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
