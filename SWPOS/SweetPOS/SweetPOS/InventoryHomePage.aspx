				...
				<ContentTemplate>
					<asp:Table runat="server" Width="100%">
						<asp:TableRow Width="100%">
							...
							<asp:TableCell Width="20%">
								<asp:Label ID="lblActiveInactive" runat="server" Text="Select Option" TextAlign="Left" />
							</asp:TableCell>
						</asp:TableRow>
						<asp:TableRow>
							<asp:TableCell>
							...
							<asp:TableCell>
								<%--Enter search text to find matching Inventory information--%>
								<asp:DropDownList ID="ddlActiveInactiveSelect" runat="server" DataValueField="intActiveInactive" DataTextField="varActiveInactive" />
							</asp:TableCell>
							<asp:TableCell Width="20%">
								<asp:Button ID="btnInventorySearch" runat="server" Width="100%" Text="Inventory Search" OnClick="btnInventorySearch_Click" />
							</asp:TableCell>
							<asp:TableCell Width="20%">
								<asp:Button ID="btnAddNewInventory" runat="server" Width="100%" Text="Add New Inventory" OnClick="btnAddNewInventory_Click" />
							</asp:TableCell>
							<asp:TableCell Width="20%">
								<asp:Button ID="btnPurchaseManagement" runat="server" Width="100%" Text="Purchase Management" OnClick="btnPurchaseManagement_Click" />
							</asp:TableCell>
						</asp:TableRow>
					</asp:Table>
