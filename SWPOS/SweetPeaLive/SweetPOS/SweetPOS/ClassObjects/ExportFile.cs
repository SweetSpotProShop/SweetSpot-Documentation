...
namespace SweetPOS.ClassObjects
{
    public class ExportFile
    {
        ...
        {
            //This method exports the return results from an inventory search.
            //Converts the results into an Excel spreadsheet.
            ...
            using (ExcelPackage xlPackage = new ExcelPackage(newFile))
            {
                ...
                int recordIndex = 2;
                //Each inventory item loops here
        ...
        //This may get used at some point* Coded to export all inventory in the database
