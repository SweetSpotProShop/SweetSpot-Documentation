...
namespace SweetPOS.ClassObjects
{
    ...
    {
        //All procedures in regards to an Invoice, Invoice Item, and Invoice Payment are stored here
        //From starting a new invoice in the invoice current table (sale in process), 
        //moving from the current table into the void cancel table (sale was cancelled or voided)
        //or moving from the current into the final table (sale was processed and finalized)
        ...
        {
            //verifies that at least one method of payment has been added to the invoice.
