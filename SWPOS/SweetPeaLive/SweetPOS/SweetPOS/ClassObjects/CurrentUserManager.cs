...
namespace SweetPOS.ClassObjects
{
    ...
    {
        //All procedures in regards to the Current User are stored here
        ...
        {
            //Converts from a Datatable in the Current User object
        ...
        {
            //Uses the given password to determine who the user is and return their information to convert from Datatable to Current User
