...
namespace SweetPOS
{
    public partial class SettingsHomePage : System.Web.UI.Page
    {
        ...
        protected void ddlTax_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                List<ProvinceTax> t = TM.ReturnTaxListBasedOnDate(Convert.ToInt32(ddlProvince.SelectedValue), Convert.ToDateTime(lblCurrentDate.Text), CU.terminal.intBusinessNumber);
